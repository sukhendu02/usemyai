    ...
    <>
      <div className='h-screen grid items-center jusity-center mb-3'>
        ...
        <div className="cta-btn text-center">
          <button className='m-2 p-2 border-blue text-blue rounded'>Explore</button>
          <button className='m-2 p-2 bg-blue-600 rounded text-white'>Sign In</button>
        </div>
        </div>
      </div>

      <div className="list-of-tools grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4 m-2 p-2">
        <div className='bg-slate-400 shadow-md p-3 m-2 rounded hover:shadow-lg flex justify-evenly  items-center'>
          <span><AutoFixHighIcon className='m-1'/></span>
